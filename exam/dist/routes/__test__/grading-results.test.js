...
it('auto-grades submitted exams and exposes results to lecturers and students', async () => {
    ...
    await (0, supertest_1.default)(app_1.app)
        ...
        .expect(201);
    const submitResponse = await (0, supertest_1.default)(app_1.app)
    ...
    const submissionsResponse = await (0, supertest_1.default)(app_1.app)
    ...
    const attemptId = submissionsResponse.body.submissions[0].attemptId;
    ...
    const resultsResponse = await (0, supertest_1.default)(app_1.app)
...
it('allows lecturers to manually override an auto-graded score', async () => {
    ...
    const submissionsResponse = await (0, supertest_1.default)(app_1.app)
        ...
        .expect(200);
    const attemptId = submissionsResponse.body.submissions[0].attemptId;
    const gradingResponse = await (0, supertest_1.default)(app_1.app)
